...
var articles = {
    'article-one': {
        title: 'Article 1 | Nair Srijith',
        heading: 'Article No.1',
        date: 'Sep 20, 2016',
        content: `
            <p>
    ...
    'article-two': {
        title: 'Article 2 | Nair Srijith',
        heading: 'Article No.2',
        date: 'Sep 22, 2016',
        content: `
            <p>
    ...
    'article-three': {
        title: 'Article 3 | Nair Srijith',
        heading: 'Article No.3',
        date: 'Sep 24, 2016',
        content: `
            <p>
...
app.get('/', function (req, res) {
  res.sendFile(path.join(__dirname, 'ui', 'article-plus.html'));
});
